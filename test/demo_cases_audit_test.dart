...
void main() {
  group('Demo Cases Audit - Human Deductive Correctness', () {
    final validator = CaseIntegrityValidator(simulator: HumanDeductionReplay(), solver: PuzzleSolver());
    ...
    test('Test 2 a 9 - Integridad de los 3 Casos Demo', () {
      for (final caseData in cases) {
        ...
        expect(result.isValid, isTrue, reason: 'Fallo en ${caseData.id}: ${result.details}');
      }
    });

    test('Test 10 - Clausura Global Demo 003 No Artificial', () {
      final simulator = HumanDeductionReplay();
